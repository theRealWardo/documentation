...
Set topic-level properties to control retention of topic data in local storage. Settings can depend on the size of your drive, how many partitions you have, and how much data you keep for each partition. 
...
- If properties are not specified:
  - New topics starting in release 22.3 use the default retention values of 1 (local) and 7 days (S3).
