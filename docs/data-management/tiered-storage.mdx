...
Set retention limits on cloud storage to purge topic data after it reaches a specified age or size, or purge data from local disks when they become full.
