...
If topics were initially created in a test environment with a replication factor of one, use `rpk topic alter-config` to change the topic replication factor: 
